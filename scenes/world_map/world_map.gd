...
var _ps1_shader := preload("res://scenes/world_map/ps1_vertex.gdshader")
...
func _toggle_menu() -> void:
	...
	camera_rig.enabled = not showing
...
func _setup_screen_fx() -> void:
	...
	mat.shader = preload("res://scenes/world_map/ps1_screen.gdshader")
